                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block" valign="top">
                                        <h3>Le propriétaire <span class="color-gre"> '.$proprio.' </span>  vient d\'ajoter un nouveau logement.</h3>
                                    </td>
                                </tr>
                               <tr>
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="'.$domaine.'/valid-lgt/'.$slg.'" class="btn-primary" itemprop="url">Voir le logement</a>
                                    </td>
                                </tr>
    ...
    <table width="100%">
        <tr>
            <td class="aligncenter content-block" align="center" valign="top">
                Merci de ne passe répondre à cet email.<br/><br/>
