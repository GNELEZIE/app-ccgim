...
if(isset($_SESSION['_ccgim_202']) and isset($_POST['nom_lgt']) and isset($_POST['categorie']) and isset($_POST['superficie']) and isset($_POST['chambre']) and isset($_POST['salles_bain']) and isset($_POST['lit']) and isset($_POST['supplementaire']) and isset($_POST['descriptions'])  and isset($_SESSION['myformkey']) and isset($_POST['formkeyDesc']) and $_SESSION['myformkey'] == $_POST['formkeyDesc']){
    ...
    $save = $logement->addDescription($dateGmt,$nom_lgt,$slug,$categorie,$superficie,$chambre,$lit,$salles_bain ,$descriptions,$supplementaire,$_SESSION['_ccgim_202']['id_utilisateur']);
    if($save > 0){
