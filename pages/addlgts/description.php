...
require_once $controller.'/logement.description.update.php';
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom_lgt" id="nom_lgt" class="form-control input-style input-height" placeholder="Nom du logement" value="<?=html_entity_decode(stripslashes($lgtData['nom_lgt']))?>"  required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="superficie" id="superficie" class="form-control input-style input-height" placeholder="Superficie"  value="<?=html_entity_decode(stripslashes($lgtData['superficie']))?>"  required style="padding-right: 33px;" step="any">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="chambre" id="chambre" class="form-control input-style input-height" placeholder="Chambres" value="<?=html_entity_decode(stripslashes($lgtData['chambres']))?>" required style="padding-right: 33px;">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salles_bain" id="salles_bain" class="form-control input-style input-height" placeholder="Salles De Bain" value="<?=html_entity_decode(stripslashes($lgtData['bain']))?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="lit">Lits  (1 Lit = 1 Pers) </label>
                                    <input type="text" name="lit" id="lit" class="form-control input-style input-height" placeholder="Lits  (1 Lit = 1 Pers)"  value="<?=html_entity_decode(stripslashes($lgtData['lit']))?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descriptions" id="descriptions" class="form-control" rows="5" placeholder="Description de la propriété"  required> <?=html_entity_decode(stripslashes($lgtData['description']))?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="supplementaire" id="supplementaire" class="form-control" rows="3" placeholder="Informations supplémentaires"><?=html_entity_decode(stripslashes($lgtData['infos_sup']))?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
